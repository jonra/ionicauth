...
var ProfilePage = /** @class */ (function () {
    function ProfilePage(ft, db) {
        var _this = this;
        this.ft = ft;
        this.db = db;
        var abc = this.ft.collection('profile').valueChanges().subscribe(function (data) {
    ...
    ProfilePage = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_fire_firestore__WEBPACK_IMPORTED_MODULE_2__["AngularFirestore"], _angular_fire_database__WEBPACK_IMPORTED_MODULE_1__["AngularFireDatabase"]])
    ], ProfilePage);
    return ProfilePage;
}());
